                ...
                <div className="pt-4 border-t border-slate-200 dark:border-slate-800 space-y-3">
                  ...
                  {project.codeSnippet && (
                    <button
                      ...
                      className="w-full py-2 rounded-xl bg-blue-600/10 hover:bg-blue-600/20 text-blue-600 dark:text-blue-400 font-bold text-xs flex items-center justify-center gap-1.5 transition-colors"
                    >
